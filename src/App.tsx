    ...
    switch (command) {
      ...
      case 'fortune':
        const fortunes = [
          ...
          'Error: DumbFun has stopped working.',
          ...
          'DumbFun: Because fun is underrated.'
        ];
      ...
      default:
        if (command.startsWith('echo ')) {
          ...
          output = 'Permission denied!\nYou cannot execute this command!\nHahaha!\n\nIn the DumbFun world, we are all equal smart people!';
