...
const App: React.FC = () => {
  ...
  const [currentUser] = useState('artificial-stupidity');
  ...
  const startLoadingSequence = () => {
    const loadingSteps = [
      ...
      'Loading Artificial Stupidity modules...',
  ...
  const executeCommand = async (input: string) => {
    ...
    switch (command) {
      ...
      case 'glitch':
        ...
        break;
      case 'dance':
        output = `💃 Terminal starts dancing! 🕺\n\n(╯°□°）╯︵ ┻━┻\n(ノಠ益ಠ)ノ彡┻━┻\n(ﾉ◕ヮ◕)ﾉ*:･ﾟ✧\n┻━┻ ︵ヽ(\`Д´)ﾉ︵﻿ ┻━┻\n\n🎵 In the Artificial Stupidity world, even terminals can dance! 🎵\n\nArtificial Stupidity > Artificial Intelligence`;
        break;
              case 'ca':
      case 'Ca':
      case 'CA':
          output = 'CertzzhwnUofK38g9vmUcL9tkeXPxotxrJpCZZA4pump\n\nArtificial Stupidity > Artificial Intelligence';
        break;
      case 'x':
      case 'twitter':
        output = '@https://x.com/StupidAI_system\n\nArtificial Stupidity > Artificial Intelligence';
        break;
      case '$vinedoge':
      case 'vinedoge':
      ...
      case 'fortune':
        const fortunes = [
          ...
          'In Artificial Stupidity we trust.',
          'Reboot your brain, not just your computer.',
          'Error: Artificial Stupidity has stopped working.',
          ...
          'Artificial Stupidity: Because stupidity is underrated.\n\nArtificial Stupidity > Artificial Intelligence'
        ];
  ...
  if (currentPhase === 'boot') {
    return (
      <div className={`App boot-animation-screen ${crashEffect ? 'crash-effect' : ''}`}>
        {/* Linux/Artificial Stupidity文字显示 */}
        {!crashEffect && (
        ...
        {animationPhase === 'loading' && (
          <div className="loading-animation">
            <div className="loading-text">Artificial Stupidity</div>
          ...
          <div className="terminal-content">
            ...
            {showInstructions && (
              <div className="instructions">
                <div className="instructions-title">=== ARTIFICIAL STUPIDITY TERMINAL GUIDE ===</div>
                <div>This is the Artificial Stupidity terminal interface. You can input any Linux command, and I will respond according to Artificial Stupidity rules.</div>
