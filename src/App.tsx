...
const App: React.FC = () => {
  ...
  const [currentUser] = useState('PenguinCult');
  ...
  useEffect(() => {
          if (animationPhase === 'dumbfun') {
              ...
              const sillyDogeText = 'PenguinCult';
      let currentIndex = 0;
      const interval = setInterval(() => {
  ...
  const executeCommand = async (input: string) => {
    ...
    switch (command) {
      ...
      case 'pixel':
        ...
        break;
      case 'glitch':
        output = 'Triggering glitch effect...\n\nThis is not a bug, this is a feature!\nIn the PenguinCult world, glitches are art!\n\nSmart > Artificial Intelligence';
        // 播放故障音效
        playSound('glitch');
        setGlitchEffect(true);
        ...
        break;
      case 'dance':
        output = `💃 Terminal starts dancing! 🕺\n\n(╯°□°）╯︵ ┻━┻\n(ノಠ益ಠ)ノ彡┻━┻\n(ﾉ◕ヮ◕)ﾉ*:･ﾟ✧\n┻━┻ ︵ヽ(\`Д´)ﾉ︵﻿ ┻━┻\n\n🎵 In the PenguinCult world, even terminals can dance! 🎵\n\nSmart > Artificial Intelligence`;
        break;
              case 'ca':
      case 'Ca':
      case 'CA':
      ...
      case 'x':
      case 'twitter':
        output = '@https://x.com/PenguinCult_xyz';
        break;
      case '$vinedoge':
      case 'vinedoge':
      ...
      case 'fortune':
        const fortunes = [
          ...
          'Good code means more bugs! This is PenguinCult philosophy!',
          'What programmers hate most: writing documentation! So we don\'t!',
          'The best code is no code! That\'s why we call it PenguinCult!',
          'Debugging is twice as hard as writing code! So we don\'t debug!',
          'Time is money, my friend! But in the PenguinCult world, time is happiness!',
      ...
      <div className={`App boot-animation-screen ${crashEffect ? 'crash-effect' : ''}`}>
        ...
        {animationPhase === 'loading' && (
          <div className="loading-animation">
            <div className="loading-text">PenguinCult</div>
    ...
    <div className={`App ${glitchEffect ? 'glitch' : ''}`}>
      ...
      <div className="terminal-container">
        <div className="terminal-header">
          ...
          <div className="terminal-title">PenguinCult v1.0.0</div>
          ...
          <div className="terminal-content">
            ...
            {showInstructions && (
              <div className="instructions">
                <div className="instructions-title">=== PENGUINCULT GUIDE ===</div>
                <div>This is the PenguinCult interface. You can input any Linux command, and I will respond according to PenguinCult rules.</div>
